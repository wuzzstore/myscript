...
username=$(curl https://raw.githubusercontent.com/wuzzstore/registr/main/ip | grep $Ip_Vps | awk '{print $2}')
echo "$username" >/usr/bin/user

# Save Expired Detail in github to /usr/bin/e
expx=$(curl https://raw.githubusercontent.com/wuzzstore/registr/main/ip | grep $Ip_Vps | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/wuzzstore/registr/main/ip | grep $Ip_Vps | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/wuzzstore/registr/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/wuzzstore/registr/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/uytrj"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6287760204418"}]]}'
...
wget raw.githubusercontent.com/LunatiX-nc/excorzscriptlunatix/main/files/limit-quota.sh && chmod +x limit-quota.sh && ./limit-quota.sh
print_install "Memasang Service Locked xray"
wget raw.githubusercontent.com/LunatiX-nc/excorzscriptlunatix/main/lock-service.sh && chmod +x lock-service.sh && ./lock-service.sh
cd
...
# install menu py
wget ${REPO_MENU}Features/WUZZ_PY
unzip WUZZ_PY
chmod +x menu/*
mv menu/* /usr/bin
rm -rf menu
